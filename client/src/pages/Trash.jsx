...
const Trash = () => {
                ...
                {userLogin.result.user_isAdmin === true ?
                    <div>
                        <a
                            className='btn-edit'
                            onClick={() => {
                                setTrashCurrId(item.id);
                                setTrashFormdata({
                                    tempat_sampah_jenis: item.tempat_sampah_jenis || '',
                                    tempat_sampah_name: item.tempat_sampah_name || '',
                                    tempat_sampah_location: item.tempat_sampah_location || '',
                                    tempat_sampah_region: item.tempat_sampah_region || '',
                                    tempat_sampah_maxcapacity: item.tempat_sampah_maxcapacity || '',
                                    tempat_sampah_isfull: item.tempat_sampah_isfull || false
                                });
                                setShow(true);
                            }}
                        >
    ...
    useEffect(() => {
        document.body.style.overflow = showww || show ? "hidden" : "";
    }, [showww, show]);
        ...
        <div>
            ...
            <div className="row">
                ...
                <Modal
                    ...
                    show={showww}
                    close={() => { setShowww(false); clearForm(); }}
                />
